...
// ─── Mini platform glyphs for feature card previews ──────────────────────────
const MINI_PLATFORM_ICONS = [
  <svg key="ig" viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324zM12 16a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm6.406-11.845a1.44 1.44 0 1 0 0 2.881 1.44 1.44 0 0 0 0-2.881z" /></svg>,
  <svg key="fb" viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>,
  <svg key="li" viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>,
  <svg key="x" viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.742l7.732-8.855L1.254 2.25H8.08l4.258 5.626zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>,
  <svg key="tt" viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="currentColor"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z" /></svg>,
];
      ...
      <main className="flex-grow">
        ...
        <section id="features" className="py-32">
          <div className="container mx-auto px-4 md:px-8">
            <SectionHeader
              label="Features"
              title="One place to run every social account"
              subtitle="Subhead: Schedule posts, track performance, and manage every platform from a single dashboard — built for teams that move fast."
            />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-8 items-stretch">
              {[
                ...
                <motion.div
                  ...
                  whileHover={{ y: -4 }}
                  className="bg-card border border-primary/[0.12] rounded-2xl p-7 text-center flex flex-col h-full transition-all duration-[250ms] hover:border-primary/50"
                >
                  ...
                  <p className="text-muted-foreground text-[15px] leading-[1.6] mb-6">{feature.desc}</p>

                  {/* Mini visual per feature */}
                  <div className="mt-auto rounded-[12px] bg-primary/[0.06] p-[14px] h-[120px] w-full flex flex-col justify-center overflow-hidden">
                    {idx === 0 && (
                      <div className="text-left space-y-2.5">
                        <div className="flex items-center gap-1.5">
                          <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-primary/15 text-primary">Brand voice</span>
                          <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-card text-muted-foreground">Confident</span>
                        </div>
                        <div className="flex items-start gap-2 bg-card rounded-lg rounded-tl-sm border border-primary/[0.12] px-3 py-2.5">
                          <Sparkles className="h-3.5 w-3.5 text-primary shrink-0 mt-0.5" />
                          <p className="text-[11.5px] text-foreground/80 leading-snug">
                            "Big news: our spring collection just dropped 🌿 Shop the looks before they're gone."
                          </p>
                        </div>
                      </div>
                    )}
                    ...
                    {idx === 1 && (
                      <div className="flex items-center justify-center gap-2.5">
                        {MINI_PLATFORM_ICONS.map((icon, i) => (
                          <div key={i} className="h-7 w-7 rounded-full bg-card text-muted-foreground flex items-center justify-center">
                            {icon}
                          </div>
                        ))}
                      </div>
                    ...
                    {idx === 2 && (
                      <div className="text-left">
                        ...
                        <div className="flex items-end justify-center gap-2 h-12 border-b border-primary/15 pb-px">
                          {[28, 38, 34, 50, 46, 66, 92].map((h, i, arr) => (
                            <div
                              key={i}
                              className="w-[9px] rounded-t-[3px]"
                              style={{
                                height: `${h}%`,
                                background: i === arr.length - 1 ? "#5C6B3C" : "rgba(92,107,60,0.25)",
                              }}
                            />
                          ))}
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex -space-x-2">
                          {[0, 1, 2].map((i) => (
                            <div
                              key={i}
                              className="h-[30px] w-[30px] rounded-full ring-2 ring-card bg-primary/15 text-primary flex items-center justify-center"
                            >
                              <User className="h-[14px] w-[14px]" strokeWidth={1.75} />
                            </div>
                          ))}
                          <div className="h-[30px] w-[30px] rounded-full ring-2 ring-card bg-foreground/10 text-foreground/70 flex items-center justify-center text-[10px] font-semibold">
                            +5
                          </div>
                        </div>
                        <span className="text-[11px] font-semibold px-2.5 py-1 rounded-full bg-primary/15 text-primary">Approved</span>
                      </div>
                    )}
                    ...
                    {idx === 4 && (
                      <div>
                        <div className="flex items-center justify-between mb-2.5">
                          ...
                          <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-primary/15 text-primary">On</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                          {["M", "T", "W", "T", "F", "S", "S"].map((d, i) => (
                            <div
                              key={i}
                              className={`h-6 w-6 rounded-full flex items-center justify-center text-[9px] font-semibold ${[0, 2, 4].includes(i) ? "bg-primary text-primary-foreground" : "bg-card text-muted-foreground"
                                }`}
                            >
                              {d}
                            </div>
                    ...
                    {idx === 5 && (
                      <div className="text-left divide-y divide-primary/[0.1]">
                        {[
                          { platform: 0, initial: "A", name: "Instagram DM", msg: "Loved the new campaign!", time: "2m", unread: true },
                          { platform: 2, initial: "M", name: "LinkedIn comment", msg: "Can you share the deck?", time: "1h", unread: false },
                        ].map((row, i) => (
                          <div key={i} className={`flex items-center gap-2.5 ${i === 0 ? "pb-2.5" : "pt-2.5"}`}>
                            <div className="relative shrink-0">
                              <div className="h-8 w-8 rounded-full bg-primary/15 text-primary flex items-center justify-center text-[11px] font-semibold">
                                {row.initial}
                              </div>
                              <div className="absolute -bottom-0.5 -right-0.5 h-4 w-4 rounded-full bg-card ring-2 ring-card text-primary flex items-center justify-center">
                                {MINI_PLATFORM_ICONS[row.platform]}
                              </div>
                            </div>
                            <div className="min-w-0 flex-1">
                              <p className="text-[11px] font-semibold text-foreground truncate">{row.name}</p>
                              <p className="text-[10.5px] text-muted-foreground truncate">{row.msg}</p>
                            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-5xl mx-auto">
              {[
                ...
                <motion.div
                  ...
                  whileHover={{ y: -4 }}
                  className={`relative p-8 rounded-3xl border flex flex-col transition-all duration-300 ${plan.featured
                ...
                >
                  ...
                  <button
                    className={`h-11 w-full rounded-[10px] text-[13px] font-semibold transition-all duration-200 ${plan.featured
